...
class Graph (object):
  ...
  # do a depth first search in a graph
    ...
    def get_neighbors (self, vertexLabel):
        ...
        index_of_v = self.get_index(vertexLabel)

        if index_of_v!=-1: #checks if vertex exists

            nVert = len (self.Vertices)
            for i in range (nVert):
                if (self.adjMat[index_of_v][i] > 0):
                    neighbors.append(i)
  ...
  #FIXME
    ...
    def delete_edge (self, fromVertexLabel, toVertexLabel):
        ...
        if from_idx!=-1 and to_idx!=-1: #checks if vertex exists
            ...
            if self.adjMat[from_idx][to_idx]==self.adjMat[to_idx][from_idx]: #undirected graph
